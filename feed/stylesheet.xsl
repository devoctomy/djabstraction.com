...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd">
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <div class="notice">This is a podcast RSS Feed generated by Jekyll. It is meant for use by podcast apps using the URL in the address bar.
        </div>
        <div class="container">
            ...
            <div class="item">
              <h2>
                <a>
                  ...
                  <xsl:attribute name="target">_blank</xsl:attribute>
                  <xsl:value-of select="concat('Episode : ', itunes:episode)"/>
                </a>
              </h2>
